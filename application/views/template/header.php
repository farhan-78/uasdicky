...
<body style="background-image: url('https://wasit.id/wallpaper/wallpaper/20310620/Unduh-gambar-hitam-polos-horizontal-Gratis-Wallpaper-gambar-background-hitam-polos-preview.jpg')">

    <!-- Navigation -->
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <a class="navbar-brand" href="#">Runeterra</a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
               ...
               <li class="nav-item">
                   <a class="nav-link" href="<?=base_url("home/kategori")?>">kategori</a>
               </li>
               <li class="nav-item">
